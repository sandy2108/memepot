        ...
        <div className='flex items-center justify-between h-full'>
          ...
          <div className="hidden md:flex items-center mb-3 justify-between">
            ...
            {navItems.map((item, index) => (
              <a href={item.link} key={index} className="mr-4">
            ...
            <div className='flex ml-10 items-center justify-between gap-5'>
             <Image src="/tw.svg" height={15} width={25} alt='twitter' className='cursor-pointer' />
             <Image src="/tg.svg" height={18} width={25} alt='telegram' className='cursor-pointer ' />
           </div>
           <div className='ml-10'>
